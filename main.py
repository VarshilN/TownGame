...
o1e1 = pygame.image.load('./Buttons/5.png')
o1e2 = pygame.image.load('./Buttons/10.png')
o1e3 = pygame.image.load('./Buttons/15.png')
...
c2_btn = buttons.Button(420,490,o1e1,0.5)
c3_btn = buttons.Button(520,490,o1e2,0.5)
e1_btn = buttons.Button(340,490,o1e1,0.5)
e2_btn = buttons.Button(440,490,o1e2,0.5)
